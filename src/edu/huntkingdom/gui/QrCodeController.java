...
public class QrCodeController implements Initializable {
    ...
    @FXML
    public void ini(Evenement cas) throws SQLException{
      /*
        ConsulterCoursActiviteController c=new ConsulterCoursActiviteController();
        CoursActivite ca;
                ca=c.envCA();*/
      
        String myWeb = "Nom de l'event= " + cas.getNomEvent()+ " , = "+cas.getDescription()+ " , le prix est = " + cas.getPrix()+ " , l'adresse est = " + cas.getAdresse();
